...
export const LongTermPersonalPlanningProducts = async () => {
  ...
  return [
    ...
    },
    {
      ...
      title: t('fiveYearVisionExecutionStrategy', {
        fallback: 'Five-Year Vision & Execution Strategy',
      }),
    ...
    },
    {
      ...
      description: t('lifeStructureDesignDescription', {
        fallback:
          'Organize your life by domains (career, personal, health, etc.) for ongoing balance.',
      }),
      price: 3000,
    },
    {
    ...
    },
    {
      ...
      description: t('valuesBasedDecisionFrameworkDescription', {
        fallback:
          'Build a filter to make all future decisions in line with your principles and purpose.',
      }),
      price: 1500,
    },
    {
