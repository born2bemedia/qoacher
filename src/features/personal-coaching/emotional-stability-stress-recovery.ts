  ...
  return [
    {
      ...
      description: t('stressExposureReviewDescription', {
        fallback:
          'Full assessment of personal and environmental stress factors with actionable insights.',
      }),
      price: 400,
    },
    {
      ...
      description: t('emotionalRegulationIntensiveDescription', {
        fallback:
          'Practical sessions to identify triggers, regulate emotional responses, and reduce reactivity.',
      }),
      price: 1200,
    },
    {
      ...
      description: t('burnoutRecoveryPlanningDescription', {
        fallback:
          'Structured recovery plan including habit shifts, boundary setting, and lifestyle correction.',
      }),
      price: 1900,
    },
    {
      ...
      description: t('energyManagementStrategyDescription', {
        fallback:
          'Analysis and redesign of energy-draining patterns across personal and professional life.',
      }),
      price: 1000,
    },
    {
      ...
      description: t('crisisResilienceCoachingDescription', {
        fallback:
          'Crisis-specific support to stabilize, refocus, and protect decision-making ability.',
      }),
      price: 1500,
    },
    {
      ...
      description: t('emotionalHealthMappingDescription', {
        fallback:
          'Evaluation of long-term emotional patterns with development of a stabilization roadmap.',
      }),
      price: 1100,
    },
  ];
