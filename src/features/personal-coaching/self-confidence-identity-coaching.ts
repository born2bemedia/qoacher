  ...
  return [
    {
      ...
      description: t('selfWorthRestorationPlanDescription', {
        fallback:
          'Comprehensive deep work on identity damage, self-worth gaps, and external validation patterns.',
      }),
      price: 2400,
    },
    {
    ...
    },
    {
      ...
      description: t('personalIdentityRebuildingDescription', {
        fallback:
          'Structured process to reconnect with personal identity, values, and inner direction.',
      }),
      price: 2000,
    },
    {
      ...
      description: t('innerCriticDeconstructionDescription', {
        fallback:
          'Identify and dismantle internal self-sabotaging narratives with guided sessions.',
      }),
      price: 900,
    },
    {
      ...
      description: t('secureSelfExpressionCoachingDescription', {
        fallback:
          'Support to confidently express opinions, emotions, and preferences without fear.',
      }),
      price: 1000,
    },
    {
