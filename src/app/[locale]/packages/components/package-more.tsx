...
export const PackageMore = () => {
  const t = useTranslations('packageMore');
  ...
  return (
    <section className="relative flex flex-col items-center justify-center gap-6 px-[48px] py-[96px] max-md:px-[16px] max-md:py-[64px]">
      ...
      <div className="relative z-2 flex justify-center gap-6 max-md:w-full">
        <Link href="/programs" className="max-md:w-1/2">
          <Button
            variant="light"
      ...
      <Image
        ...
        src={'/images/packages/package-more.png'}
        alt="hero"
        fill
        unoptimized
      />
