...
import { AffiliateProgramForm } from '@/features/affiliate-program-form/form';

import { Button } from '@/shared/ui/components/atoms/button';
import { Title } from '@/shared/ui/components/atoms/title';
import { FadeIn } from '@/shared/ui/components/templates/fade-in';

export const AffiliateProgramWantJoin = () => {
  const t = useTranslations('affiliateProgramWantJoin');
  ...
  return (
    <>
      ...
      <AffiliateProgramForm isOpen={isModalOpen} onCloseAction={() => setIsModalOpen(false)} />
    </>
  );
};
